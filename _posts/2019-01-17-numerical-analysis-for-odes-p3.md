...
qu'elles sont plus proches que la $$1$$ et la \\
$$2 (x^0_3-x^0_2=0,18<x^0_2-x^0_1=0,28)$$ ou la $$3$$ et le globule à l'extrémité en position $$1 (x^0_3-x^0_2=0,18<1-x^0_3=0,27)$$
